...
class TestScenarioService {
  ...
  async updateAsync(projectId, workId, data) {
    const url = `api/project/${projectId}/test-scenario/${workId}/${data?.id}`;
